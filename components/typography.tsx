...
export function HeadingH2({
  ...
  return (
    <h2
      className={`scroll-m-20 mb-4 text-3xl font-medium tracking-tight transition-colors first:mt-0 ${className}`}
      {...props}
    >
      {children}
    </h2>
...
export function HeadingH3({
  ...
  return (
    <h3
      className={`scroll-m-20 mb-4 text-2xl font-medium tracking-tight ${className}`}
      {...props}
    >
      {children}
    </h3>
...
export function HeadingH4({
  ...
  return (
    <h4
      className={`scroll-m-20 mb-4 text-xl font-medium tracking-tight ${className}`}
      {...props}
    >
      {children}
    </h4>
...
export function HeadingH5({
  ...
  return (
    <h5
      className={`scroll-m-20 mb-4 text-lg font-medium tracking-tight ${className}`}
      {...props}
    >
      {children}
    </h5>
...
export function TypographyLarge({
  ...
  return (
    <div className={`text-lg font-medium ${className}`} {...props}>
      {children}
    </div>
  );
}
